...
# vamos recuperar os deptos do banco
  ...
  <div class="container">
    ...
    ?>
      <div class="alert alert-warning">
        <i class="glyphicon glyphicon-warning-sign"></i> ERRO NA EXCLUSÃO : DEPARTAMENTO POSSUI FUNCIONÁRIOS VINCULADOS
      </div>
    <?php
    }
    ?>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right">
            ...
            <!-- link para exclusão do registro -->
